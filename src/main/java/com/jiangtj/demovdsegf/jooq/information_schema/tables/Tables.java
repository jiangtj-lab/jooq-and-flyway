...
import com.jiangtj.demovdsegf.jooq.information_schema.enums.TablesRowFormat;
import com.jiangtj.demovdsegf.jooq.information_schema.enums.TablesTableType;
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.TablesRecord;
...
public class Tables extends TableImpl<TablesRecord> {
     ...
     */
    public final TableField<TablesRecord, TablesTableType> TABLE_TYPE = createField(DSL.name("TABLE_TYPE"), SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.TablesTableType.class), this, "");
     ...
     */
    public final TableField<TablesRecord, TablesRowFormat> ROW_FORMAT = createField(DSL.name("ROW_FORMAT"), SQLDataType.VARCHAR(10).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.TablesRowFormat.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function21<? super String, ? super String, ? super String, ? super TablesTableType, ? super String, ? super Integer, ? super TablesRowFormat, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super Long, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function21<? super String, ? super String, ? super String, ? super TablesTableType, ? super String, ? super Integer, ? super TablesRowFormat, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super Long, ? super String, ? super String, ? extends U> from) {

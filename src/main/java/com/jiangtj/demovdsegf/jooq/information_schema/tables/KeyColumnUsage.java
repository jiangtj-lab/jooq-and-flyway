...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.KeyColumnUsageRecord;
...
public class KeyColumnUsage extends TableImpl<KeyColumnUsageRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function12<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super UInteger, ? super UInteger, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function12<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super UInteger, ? super UInteger, ? super String, ? super String, ? super String, ? extends U> from) {

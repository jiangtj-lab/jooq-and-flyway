...
import com.jiangtj.demovdsegf.jooq.information_schema.enums.ParametersRoutineType;
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.ParametersRecord;
...
public class Parameters extends TableImpl<ParametersRecord> {
     ...
     */
    public final TableField<ParametersRecord, ParametersRoutineType> ROUTINE_TYPE = createField(DSL.name("ROUTINE_TYPE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.ParametersRoutineType.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function16<? super String, ? super String, ? super String, ? super ULong, ? super String, ? super String, ? super String, ? super Long, ? super Long, ? super UInteger, ? super Long, ? super UInteger, ? super String, ? super String, ? super String, ? super ParametersRoutineType, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function16<? super String, ? super String, ? super String, ? super ULong, ? super String, ? super String, ? super String, ? super Long, ? super Long, ? super UInteger, ? super Long, ? super UInteger, ? super String, ? super String, ? super String, ? super ParametersRoutineType, ? extends U> from) {

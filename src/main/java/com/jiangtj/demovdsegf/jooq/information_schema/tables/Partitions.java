...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.PartitionsRecord;
...
public class Partitions extends TableImpl<PartitionsRecord> {
    ...
    @Override
    public Partitions as(Table<?> alias) {
        return new Partitions(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Partitions rename(Table<?> name) {
        return new Partitions(name.getQualifiedName(), null);
    }
}

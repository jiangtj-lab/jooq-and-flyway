...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.InnodbFtDefaultStopwordRecord;
...
public class InnodbFtDefaultStopword extends TableImpl<InnodbFtDefaultStopwordRecord> {
    ...
    @Override
    public InnodbFtDefaultStopword as(Table<?> alias) {
        return new InnodbFtDefaultStopword(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public InnodbFtDefaultStopword rename(Table<?> name) {
        return new InnodbFtDefaultStopword(name.getQualifiedName(), null);
    }

...
import com.jiangtj.demovdsegf.jooq.information_schema.enums.CollationsPadAttribute;
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.CollationsRecord;
...
public class Collations extends TableImpl<CollationsRecord> {
     ...
     */
    public final TableField<CollationsRecord, CollationsPadAttribute> PAD_ATTRIBUTE = createField(DSL.name("PAD_ATTRIBUTE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.CollationsPadAttribute.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super String, ? super String, ? super ULong, ? super String, ? super String, ? super UInteger, ? super CollationsPadAttribute, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super String, ? super String, ? super ULong, ? super String, ? super String, ? super UInteger, ? super CollationsPadAttribute, ? extends U> from) {

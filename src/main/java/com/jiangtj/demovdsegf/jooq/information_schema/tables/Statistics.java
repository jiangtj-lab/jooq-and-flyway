...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.StatisticsRecord;
...
public class Statistics extends TableImpl<StatisticsRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function18<? super String, ? super String, ? super String, ? super Integer, ? super String, ? super String, ? super UInteger, ? super String, ? super String, ? super Long, ? super Long, ? super byte[], ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function18<? super String, ? super String, ? super String, ? super Integer, ? super String, ? super String, ? super UInteger, ? super String, ? super String, ? super Long, ? super Long, ? super byte[], ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? extends U> from) {

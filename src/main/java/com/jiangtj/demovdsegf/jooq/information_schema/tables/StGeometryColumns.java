...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.StGeometryColumnsRecord;
...
public class StGeometryColumns extends TableImpl<StGeometryColumnsRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super String, ? super String, ? super String, ? super String, ? super String, ? super UInteger, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super String, ? super String, ? super String, ? super String, ? super String, ? super UInteger, ? super String, ? extends U> from) {

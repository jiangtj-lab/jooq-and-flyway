...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.InnodbColumnsRecord;
...
public class InnodbColumns extends TableImpl<InnodbColumnsRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super ULong, ? super String, ? super ULong, ? super Integer, ? super Integer, ? super Integer, ? super Integer, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super ULong, ? super String, ? super ULong, ? super Integer, ? super Integer, ? super Integer, ? super Integer, ? super String, ? extends U> from) {

...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.InnodbMetricsRecord;
...
public class InnodbMetrics extends TableImpl<InnodbMetricsRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function17<? super String, ? super String, ? super Long, ? super Long, ? super Long, ? super Double, ? super Long, ? super Long, ? super Long, ? super Double, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? super LocalDateTime, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function17<? super String, ? super String, ? super Long, ? super Long, ? super Long, ? super Double, ? super Long, ? super Long, ? super Long, ? super Double, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? super LocalDateTime, ? super String, ? super String, ? super String, ? extends U> from) {

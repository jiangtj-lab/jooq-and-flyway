...
import com.jiangtj.demovdsegf.jooq.information_schema.enums.EventsIntervalField;
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
     ...
     */
    public final TableField<EventsRecord, EventsIntervalField> INTERVAL_FIELD = createField(DSL.name("INTERVAL_FIELD"), SQLDataType.VARCHAR(18).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.EventsIntervalField.class), this, "");
     ...
     */
    public final TableField<EventsRecord, String> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(21).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

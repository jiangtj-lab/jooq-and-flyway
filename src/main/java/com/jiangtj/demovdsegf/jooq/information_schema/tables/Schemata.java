...
import com.jiangtj.demovdsegf.jooq.information_schema.enums.SchemataDefaultEncryption;
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.SchemataRecord;
...
public class Schemata extends TableImpl<SchemataRecord> {
     ...
     */
    public final TableField<SchemataRecord, SchemataDefaultEncryption> DEFAULT_ENCRYPTION = createField(DSL.name("DEFAULT_ENCRYPTION"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.SchemataDefaultEncryption.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super String, ? super String, ? super String, ? super String, ? super byte[], ? super SchemataDefaultEncryption, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super String, ? super String, ? super String, ? super String, ? super byte[], ? super SchemataDefaultEncryption, ? extends U> from) {

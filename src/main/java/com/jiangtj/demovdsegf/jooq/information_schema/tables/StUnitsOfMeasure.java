...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.StUnitsOfMeasureRecord;
...
public class StUnitsOfMeasure extends TableImpl<StUnitsOfMeasureRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super String, ? super String, ? super Double, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super String, ? super String, ? super Double, ? super String, ? extends U> from) {

...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.TableConstraintsExtensionsRecord;
...
public class TableConstraintsExtensions extends TableImpl<TableConstraintsExtensionsRecord> {
    ...
    @Override
    public TableConstraintsExtensions as(Table<?> alias) {
        return new TableConstraintsExtensions(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public TableConstraintsExtensions rename(Table<?> name) {
        return new TableConstraintsExtensions(name.getQualifiedName(), null);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super String, ? super String, ? super String, ? super String, ? super JSON, ? super JSON, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super String, ? super String, ? super String, ? super String, ? super JSON, ? super JSON, ? extends U> from) {

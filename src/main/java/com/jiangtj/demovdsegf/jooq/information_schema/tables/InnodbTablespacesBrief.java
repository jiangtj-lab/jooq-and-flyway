...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.InnodbTablespacesBriefRecord;
...
public class InnodbTablespacesBrief extends TableImpl<InnodbTablespacesBriefRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super byte[], ? super String, ? super String, ? super byte[], ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super byte[], ? super String, ? super String, ? super byte[], ? super String, ? extends U> from) {

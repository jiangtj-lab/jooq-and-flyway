...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.InnodbSessionTempTablespacesRecord;
...
public class InnodbSessionTempTablespaces extends TableImpl<InnodbSessionTempTablespacesRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super UInteger, ? super UInteger, ? super String, ? super ULong, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super UInteger, ? super UInteger, ? super String, ? super ULong, ? super String, ? super String, ? extends U> from) {

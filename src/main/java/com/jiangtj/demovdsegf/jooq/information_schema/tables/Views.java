...
import com.jiangtj.demovdsegf.jooq.information_schema.tables.records.ViewsRecord;
...
public class Views extends TableImpl<ViewsRecord> {
     ...
     */
    public final TableField<ViewsRecord, ViewsCheckOption> CHECK_OPTION = createField(DSL.name("CHECK_OPTION"), SQLDataType.VARCHAR(8).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.ViewsCheckOption.class), this, "");

    /**
     * The column <code>information_schema.VIEWS.IS_UPDATABLE</code>.
     */
    public final TableField<ViewsRecord, ViewsIsUpdatable> IS_UPDATABLE = createField(DSL.name("IS_UPDATABLE"), SQLDataType.VARCHAR(3).asEnumDataType(com.jiangtj.demovdsegf.jooq.information_schema.enums.ViewsIsUpdatable.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function10<? super String, ? super String, ? super String, ? super String, ? super ViewsCheckOption, ? super ViewsIsUpdatable, ? super String, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function10<? super String, ? super String, ? super String, ? super String, ? super ViewsCheckOption, ? super ViewsIsUpdatable, ? super String, ? super String, ? super String, ? super String, ? extends U> from) {
